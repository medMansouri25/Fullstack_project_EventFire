      ...
      <div className="details-content">
        ...
        <div className="price-card">
          <div className="price-main">
            ...
            {prix === 0 || prix === undefined || prix === null ? 'Gratuit' : `${prix}€`}
          </div>
          <p className="price-sub">par billet</p>
          <AvailabilityBar capacite={capacite} billetsVendus={billetsVendus} />
          <button className="btn btn-primary reserve-btn">Réserver maintenant</button>
          <p className="secure-note">Réservation sécurisée • Annulation gratuite</p>
        </div>
      </div>
    </div>
  );
